...
\structure{\textbf{(1) a priori estimate for particles using odometry}}
...
\structure{\textbf{(2) a posteriori estimate for particles and map using scan matching}}
...
\structure{\textbf{(3) re-sample particles}}

\begin{lstlisting}[language=Matlab]
%if Neff < alpha * num_particles
%    particles = resample_particles( particles, ...
        a_posteriori_weights, params );
%end
\end{lstlisting}
%\end{verbatim}
